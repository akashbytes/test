...
if (isset($_POST['add'])) {
    ...
    $products->id = htmlentities(trim($_POST['id']));
                        ...
                        <div class="white-box">
                            ...
                            <form class="form-horizontal" method="post" enctype="mutipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" name="name" value="<?=$res['name'];?>" class="form-control"  placeholder=""> 
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Price </label>
                                    <div class="col-md-12">
                                        <input type="text" name="price" value="<?=$res['price'];?>" class="form-control"  placeholder=""> 
                                    </div>
                                </div>
