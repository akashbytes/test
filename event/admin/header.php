...
<!-- Mirrored from wrappixel.com/ampleadmin/ampleadmin-html/ampleadmin-minimal/blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 03 Jan 2019 12:58:01 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <title><?php  echo "Event Admin"  ?></title>
    <!-- Bootstrap Core CSS -->
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="../plugins/images/users/varun.jpg" alt="user-img" width="36" class="img-circle"><b class="hidden-xs"><?php   echo $_SESSION['username']  ?></b><span class="caret"></span> </a>
                            ...
                            <li>
                                <div class="dw-user-box">
                                    ...
                                    <div class="u-text">
                                        ...
                                        <p class="text-muted"><?php   echo $_SESSION['email']  ?></p><!-- <a href="#" class="btn btn-rounded btn-danger btn-sm">View Profile</a> --></div>
                                </div>
                            </li>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <ul class="nav" id="side-menu">
                        <li> <a href="dashboard.php" class="waves-effect"><i class="mdi mdi-av-timer fa-fw"></i><span class="hide-menu"> Dashboard</span></a> </li>

                        <li> <a href="products-view.php" class="waves-effect"><i class="mdi mdi-cart-outline fa-fw"></i><span class="hide-menu"> Products</span></a> </li>
                        <!-- <li> <a href="logout.php" class="waves-effect"><i class="mdi mdi-logout fa-fw"></i><span class="hide-menu"> Logout</span></a> </li> -->
                       <!--  <li> <a href="table.php" class="waves-effect"><i class="mdi mdi-av-timer fa-fw"></i><span class="hide-menu"> Table</span></a> </li>
                        <li> <a href="form.php" class="waves-effect"><i class="mdi mdi-av-timer fa-fw"></i><span class="hide-menu"> Form</span></a> </li> -->
                        <!-- <li> <a href="task.php" class="waves-effect"><i class="mdi mdi-grease-pencil"></i><span class="hide-menu"> Tasks</span></a> </li> -->
                        <!-- <li> <a href="messages.php" class="waves-effect"><i class="mdi mdi-message"></i><span class="hide-menu"> Messages</span></a> </li> -->
